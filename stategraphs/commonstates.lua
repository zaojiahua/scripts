...
-- CommonEventHandler
-- 定义普遍意义的事件-状态关联
-- 包含的事件有 step gotosleep freeze attacked doattack death locomote
-- 具体状态在后面定义，保存在CommonStates里面
...
-- 每个物体的状态定义在其对应的 SGobject.lua 文件中（SG是StateGraph的缩写）
-- 定义了特殊的状态states之后，可以使用下面的函数向states中添加一些通用的状态。
