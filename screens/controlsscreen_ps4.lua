...
local LABELS = {
    [1] = {},
    [DEVICE_DUALSHOCK4] = {
        { x = 20,        y = 250,  anchor = ANCHOR_RIGHT, text = STRINGS.UI.CONTROLSSCREEN.PS4.TOUCHPAD },
        { x = 80,        y = 250,  anchor = ANCHOR_LEFT,  text = STRINGS.UI.CONTROLSSCREEN.PS4.OPTIONS },

        { x = LEFT_SIDE, y = 230,  anchor = ANCHOR_RIGHT, text = STRINGS.UI.CONTROLSSCREEN.PS4.L2 },
        { x = LEFT_SIDE, y = 130,  anchor = ANCHOR_RIGHT, text = STRINGS.UI.CONTROLSSCREEN.PS4.L1 },

        { x = LEFT_SIDE, y = 30,   anchor = ANCHOR_RIGHT, text = STRINGS.UI.CONTROLSSCREEN.PS4.DPAD_UP },
        { x = LEFT_SIDE, y = -10,  anchor = ANCHOR_RIGHT, text = STRINGS.UI.CONTROLSSCREEN.PS4.DPAD_LEFT },
        { x = LEFT_SIDE, y = -50,  anchor = ANCHOR_RIGHT, text = STRINGS.UI.CONTROLSSCREEN.PS4.DPAD_BOTTOM },
        { x = LEFT_SIDE, y = -90, anchor = ANCHOR_RIGHT, text = STRINGS.UI.CONTROLSSCREEN.PS4.DPAD_RIGHT },

        { x = LEFT_SIDE, y = -220, anchor = ANCHOR_RIGHT, text = STRINGS.UI.CONTROLSSCREEN.PS4.L3 },

        { x = RIGHT_SIDE, y = 230,  anchor = ANCHOR_LEFT, text = STRINGS.UI.CONTROLSSCREEN.PS4.R2 },
        { x = RIGHT_SIDE, y = 130,  anchor = ANCHOR_LEFT, text = STRINGS.UI.CONTROLSSCREEN.PS4.R1 },

        { x = RIGHT_SIDE, y = 30,   anchor = ANCHOR_LEFT, text = STRINGS.UI.CONTROLSSCREEN.PS4.TRIANGLE },
        { x = RIGHT_SIDE, y = -10,  anchor = ANCHOR_LEFT, text = STRINGS.UI.CONTROLSSCREEN.PS4.CIRCLE },
        { x = RIGHT_SIDE, y = -50,  anchor = ANCHOR_LEFT, text = STRINGS.UI.CONTROLSSCREEN.PS4.CROSS },
        { x = RIGHT_SIDE, y = -90, anchor = ANCHOR_LEFT, text = STRINGS.UI.CONTROLSSCREEN.PS4.SQUARE },

        { x = RIGHT_SIDE, y = -220, anchor = ANCHOR_LEFT, text = STRINGS.UI.CONTROLSSCREEN.PS4.R3 },
    },
    [DEVICE_VITA] = {
...
function ControlsScreen:PopulateLayout(device)
    ...
    image:SetPosition( -3,0,0 )
    
    for _, v in pairs(LABELS[device]) do
        local label = layout:AddChild(Text(TITLEFONT, 35))
