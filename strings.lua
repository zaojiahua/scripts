...
STRINGS.UI =
{
	...
	CONTROLSSCREEN=
	{
	    ...
	    INPUTS = { 
	        ...
	        [4] = { 
                ...
                -- Analog          
                "\235",--"Left Thumb Left",
                "\234",--"Left Thumb Right",
                "\236",--"Left Thumb Down",
                "\237",--"Left Thumb Up",
	            "\231",--"Right Thumb Left",
	            "\230",--"Right Thumb Right",
	            "\232",--"Right Thumb Down",
	            "\233",--"Right Thumb Up",
                "\245",--"Left Trigger",
                "\245",--"Left Trigger",
                "\242",--"Right Trigger",
	...
	{	    
	    ...
	    DATA_DAMAGED = "Your data is corrupt and cannot be used",
